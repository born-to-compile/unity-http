...
using BornToCompile.Http.Service;
using BornToCompile.Http.Service.Unity;
using UnityEngine;
using UnityEngine.Networking;

namespace BornToCompile.Http
{
	public sealed class Http : MonoBehaviour
	{
		...
		/// <see cref="IHttpService.Post(string,UnityEngine.WWWForm)"/>
		public static IHttpRequest Post(string uri, WWWForm formData)
		{
			return Instance.service.Post(uri, formData);
		}

		/// <see cref="IHttpService.Post(string,System.Collections.Generic.Dictionary{string,string})"/>
		public static IHttpRequest Post(string uri, Dictionary<string, string> formData)
		{
			return Instance.service.Post(uri, formData);
		}

		/// <see cref="IHttpService.Post(string,System.Collections.Generic.List{UnityEngine.Networking.IMultipartFormSection})"/>
		...
		/// <see cref="IHttpService.PostJson{T}"/>
